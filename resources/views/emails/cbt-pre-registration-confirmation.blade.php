...
<body>
    <div class="container">
        ...
        <!-- Content -->
        <div class="content">
            <p class="greeting">Bonjour <strong>{{ $member->name }}</strong>,</p>
            ...
            <div class="info-box">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px 0; color: #555;">{{ $member->name }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: 600; color: #333;">Email</td>
                        <td style="padding: 8px 0; color: #555;">{{ $member->email }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: 600; color: #333;">Numéro de compte</td>
                        <td style="padding: 8px 0; color: #555;">{{ $member->account_number }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 8px 0; font-weight: 600; color: #333;">Date</td>
                        <td style="padding: 8px 0; color: #555;">{{ $member->created_at->format('d/m/Y H:i') }}</td>
                    </tr>
                </table>
            </div>
