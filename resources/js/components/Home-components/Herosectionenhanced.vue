    ...
    <div class="relative z-10 h-full flex items-center">
        <div class="max-w-350 mx-auto px-2 lg:px-8 w-full">
            <div class="max-w-4xl mx-auto text-center pt-16">
                <!-- Titre principal -->
                <h1 class="text-white font-extrabold text-3xl sm:text-5xl md:text-6xl lg:text-5xl leading-[1.1] tracking-tight animate-fade-in">
                    {{ slides[currentSlide]?.text || 'Bienvenue chez Cofina Togo' }}
                </h1>

                <!-- Boutons CTA -->
                <div class="flex flex-col sm:flex-row gap-4 justify-center pt-2 sm:pt-4 md:pt-6 lg:pt-10 animate-fade-in-delay-2">
                    <router-link
